...
本项目采用 [GNU GPLv3](LICENSE)（`GPL-3.0-only`）。向本项目提交供合并的原创代码、测试或文档，表示你有权提供这些内容，并同意以相同许可证授权该贡献；贡献者保留其版权。

引入第三方内容时，请注明来源、保留原有版权及许可证声明，并确认其许可条件与 GPLv3 兼容。不得将无权授权的内容提交到仓库。
